...
namespace ShellEV.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<MarkersResponse>),
        new Type[] {
    ...
    public abstract class MarkersResponse
    {
        ...
        /// </summary>
        /// <returns>
        /// The MarkersResponse instance, wrapping the provided SingleLocationMarker value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The MarkersResponse instance, wrapping the provided MultiLocationMarker value.
        /// </returns>
        ...
        private sealed class SingleLocationMarkerCase : MarkersResponse, ICaseValue<SingleLocationMarkerCase, SingleLocationMarker>
        {
        ...
        private sealed class MultiLocationMarkerCase : MarkersResponse, ICaseValue<MultiLocationMarkerCase, MultiLocationMarker>
        {
