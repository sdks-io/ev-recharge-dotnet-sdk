// <copyright file="V2ChargeSessionRetrieve404ErrorException.cs" company="APIMatic">
// ShellEV.Standard
//
...
namespace ShellEV.Standard.Exceptions
{
    ...
    /// </summary>
    public class V2ChargeSessionRetrieve404ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ChargeSessionRetrieve404ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public V2ChargeSessionRetrieve404ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"V2ChargeSessionRetrieve404ErrorException : ({string.Join(", ", toStringOutput)})";
        }
