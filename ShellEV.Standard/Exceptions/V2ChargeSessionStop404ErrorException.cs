// <copyright file="V2ChargeSessionStop404ErrorException.cs" company="APIMatic">
// ShellEV.Standard
//
...
namespace ShellEV.Standard.Exceptions
{
    ...
    /// </summary>
    public class V2ChargeSessionStop404ErrorException : ApiException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ChargeSessionStop404ErrorException"/> class.
        /// </summary>
        /// <param name="reason"> The reason for throwing exception.</param>
        /// <param name="context"> The HTTP context that encapsulates request and response objects.</param>
        public V2ChargeSessionStop404ErrorException(string reason, HttpContext context)
            : base(reason, context)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"V2ChargeSessionStop404ErrorException : ({string.Join(", ", toStringOutput)})";
        }
